...
#    ['Fiber', 'Node', 'AB', 'IsInstalled', 'IsDead', 'Type'],
    ...
    [73, 73, 'A', False, False, 'BULK'],
    [74, 74, 'A', False, False, 'BULK'],
    [75, 75, 'A', False, False, 'BULK'],
    ...
    [100, 92, 'A', True, False, 'SPARE'],
    [101, 49, 'A', False, False, 'SPARE'],
